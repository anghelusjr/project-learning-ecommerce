...
export function renderOrderSummary() {
  ...
  if(getCartQuantity() === 0){
    document.querySelector('.js-order-summary').innerHTML = `<p class="js-empty-cart-text"> Oops! Your cart is empty.</p>`;
  }else{
      ...
      document.querySelector('.js-order-summary').innerHTML = gridHTML;
